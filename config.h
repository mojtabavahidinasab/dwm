...
static const Key keys[] = {
	...
	{ MODKEY,			XK_Insert,     spawn,                  SHCMD("xdotool type $(grep -v '^#' ~/.local/share/larbs/snippets/urls | dmenu -i -l 33 | cut -d' ' -f1)") },
	{ MODKEY|ShiftMask,		XK_Insert,     spawn,          	       SHCMD("xdotool type $(grep -v '^#' ~/.local/share/larbs/snippets/tokens | dmenu -i -l 33 | cut -d' ' -f1)") },
